...
beta <- 1/40 
alpha1 <- 0.5
piMeasure1 <- setPiMeasure(type='gamma2', prm=alpha1, beta=beta, T_WarmUp=2)
alpha2 <- 0.7
piMeasure2 <- setPiMeasure(type='gamma2', prm=alpha2, beta=beta, T_WarmUp=2)
...
if(ToPDF) pdf('fig4.pdf',width=12,height=3)
par(mar=c(2.1, 1.1, 1.1, 1.1))
plot(supOU1$t,pmin(x1,5)+0,type='l',col=col[1],xlab='',ylab='',ylim=c(0,10),xaxs="i",yaxt='n')
